/**
 * This class is used to model a hand of straightflush in a Big Two card game.
 * 
...
public class StraightFlush extends Hand {
	...
	public boolean isValid() {
		...
		if (size() == 5) {
			// check whether this hand has the same suit or not
	 ...
	 * 
	 * @return "StraightFlush" The name of this class as a String object.
	 */
